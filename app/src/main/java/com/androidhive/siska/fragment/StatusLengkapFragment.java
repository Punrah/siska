...
public class StatusLengkapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflate=inflater.inflate(R.layout.fragment_status_lengkap, container, false);
        ...
        lv = (ListView) myInflate.findViewById(R.id.list_status_lengkap);
    ...
    private class getData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            url = AppConfig.URL_STATUS_LENGKAP+MainActivity.username;
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.list_status_lengkap, new String[]{"judul", "uji1", "uji2","pem1","pem2","status","tgl_ujian","tgl_konfirmasi"
