...
public class StatusMahasiswaFragment extends Fragment {


    private String TAG = StatusMahasiswaFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View myInflate=inflater.inflate(R.layout.fragment_status_mahasiswa, container, false);
        ...
        lv = (ListView) myInflate.findViewById(R.id.list_status_mahasiswa);
    ...
    private class getData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            url = AppConfig.URL_STATUS_MAHASISWA+MainActivity.username;
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.list_status_mahasiswa, new String[]{"judul", "uji1", "uji2","pem1","pem2","status","tgl_ujian","tgl_konfirmasi"
            }, new int[]{R.id.judul, R.id.uji1, R.id.uji2,R.id.pem1, R.id.pem2, R.id.status,R.id.tgl_ujian, R.id.tgl_konfirmasi});
